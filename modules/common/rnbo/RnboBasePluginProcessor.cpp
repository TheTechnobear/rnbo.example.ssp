...
#include "RnboBasePluginEditor.h"
...
RnboBasePluginProcessor::RnboBasePluginProcessor()
    : RnboBasePluginProcessor(getBusesProperties(), createParameterLayout()) {}
...
RnboBasePluginProcessor::RnboParam::RnboParam(AudioProcessorValueTreeState &apvt, StringRef id, unsigned idx) :
...
RnboBasePluginProcessor::PluginParams::PluginParams(AudioProcessorValueTreeState &apvt) {
    RNBO::CoreObject rnboObj_;
...
AudioProcessorValueTreeState::ParameterLayout RnboBasePluginProcessor::createParameterLayout() {
...
const String RnboBasePluginProcessor::getInputBusName(int channelIndex) {
    RNBO::CoreObject rnboObj_;
...
const String RnboBasePluginProcessor::getOutputBusName(int channelIndex) {
    RNBO::CoreObject rnboObj_;
...
void RnboBasePluginProcessor::prepareToPlay(double sampleRate, int samplesPerBlock) {
...
void RnboBasePluginProcessor::processBlock(AudioSampleBuffer &buffer, MidiBuffer &midiMessages) {
