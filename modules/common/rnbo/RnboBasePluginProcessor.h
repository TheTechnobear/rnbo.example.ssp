...
class RnboBasePluginProcessor : public ssp::BaseProcessor {
public:
    explicit RnboBasePluginProcessor();
    explicit RnboBasePluginProcessor(const AudioProcessor::BusesProperties &ioLayouts, AudioProcessorValueTreeState::ParameterLayout layout);
    ~RnboBasePluginProcessor();
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (RnboBasePluginProcessor)
};
