...
RnboBasePluginEditor::RnboBasePluginEditor(RnboBasePluginProcessor &p, unsigned maxviews)
...
void RnboBasePluginEditor::drawView(Graphics &g) {
    base_type::drawView(g);
}


void RnboBasePluginEditor::resized() {
    base_type::resized();
}
